        ...
        <>
            ...
            <main>
                <section className="mt-10">
                    ...
                    {/* Hero image/gif */}
                    <div style={elementStyle} className="h-[500px] rounded-md p-5 w-2/3 mx-auto backdrop-layers">
                        <img src="" alt="Hero image" />
                    </div>
                </section>
                <section className="mt-32 py-16 space-y-16 bg-gradient-to-b from-shade-bg to-white">
                    <h2 className="inter-heading text-5xl text-center">Social Media {`<>`} Academia</h2>
                    <p className="text-center px-16 text-lg text-slate-600"> Daatelli is designed to give you the experience of an Academic using a social media-like interface all while taking care of the things you care about such as copyright protection and document privacy.</p>
                    <div className="h-[400px] rounded-md p-5 w-2/3 mx-auto backdrop-layers">
                ...
                <section className="mt-32 p-16">
                    <div className="flex flex-row-reverse">
                        <div className="w-1/2 space-y-5">
                            ...
                            <p className="max-w-md text-lg text-slate-600">Gain insights from past and trending research so you can understand what is important for your next field study.</p>
                        </div>
                        <div className="w-1/2">
                ...
                <section className="min-h-[500px] mt-32 p-5 bg-gradient-to-b from-shade-bg to-white relative">
                    <div className="flex">
                        <div className="w-1/2 border-r border-gray-200 space-y-5 mt-16">
                            <h2 className="inter-heading text-5xl">API <span className="badge badge-outline">Coming soon</span></h2>
                            <p className="max-w-md text-lg text-slate-600">Extend the capabilities of your ML models, your applications and other functions with Daatelli's API.</p>
                ...
                <section className="mt-32 py-16 space-y-5">
                    <h2 className="inter-heading text-5xl text-center text-gradient-primary">Join the community</h2>
                    <p className="text-center px-16 text-lg text-slate-600">Daatelli is a community of researchers, academics, students and many more individuals who are passionate about sharing their knowledge and insights with the world in quick and easy ways.</p>
                    <div className="flex justify-center gap-6">
                        <div className="card w-96 shadow-md cursor-pointer" onClick={() => window.location.href = "https://github.com/Olanrewajuemmanuel/Daatelli"}>
                            <div className="card-body">
                                ...
                                <p className="text-slate-600">Star our repo, contribute code and share insights in the discussions.</p>
                            </div>
                        </div>
                        <div className="card w-96 shadow-md cursor-pointer" onClick={() => window.location.href = "https://t.me/+n7QeLDKposwzYmZk"}>
                            <div className="card-body">
                                <span className="w-24 card-actions">
                                    {/* Telegram icon */}
                                ...
                                <p className="text-slate-600">Join our community and stay updated with the latest news and updates.</p>
                            </div>
