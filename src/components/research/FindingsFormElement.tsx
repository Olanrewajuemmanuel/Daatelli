    ...
    return (
        <div className="border">
            ...
            <div hidden={!findingsText} className="cursor-pointer" >
                ...
                {displayCite && <Citations citations={findingsCitation} onCitationUpdate={handleCitationUpdate} />}
                <span>EnterIcon</span>
            </div>
